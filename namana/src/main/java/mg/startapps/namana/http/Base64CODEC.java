...
/**
 * Created by Onion Knight on 29/11/2017.
 */
...
public class Base64CODEC
{
	...
	public static String fetchBase64Image(String url)
	{
		Base64CODEC base64CODEC = new Base64CODEC();
		Bitmap bitmap = base64CODEC.Base64ImageFromURL(url);
		return base64CODEC.convertToBase64(bitmap);
	}
}