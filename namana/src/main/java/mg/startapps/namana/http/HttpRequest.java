package mg.startapps.namana.http;

/**
 * Created by Onion Knight on 28/09/2016.
 */
...
public class HttpRequest
{
     ...
     *
     * @param method Method - indicates whether this request should be sent in POST method
    ...
    public HttpRequest withData(HashMap<String, String> params) throws IOException
    {
        ...
        this.withData(result.toString());
        return this;
    }

    public void withJsonString(String jsonString) throws IOException
    {
    ...
    {
        BufferedReader br = new BufferedReader(new InputStreamReader(con.getInputStream(), "utf-8"), 8);
